<header id="slider-area">  
  <nav id="navbar" class="navbar navbar-expand-md fixed-top scrolling-navbar bg-white">
    <div class="container">          
      <a href="#" class="navbar-brand"><img src="{{asset('images/domotiklux/logo.png')}}" alt=""></a>       
    ...
    <div id="carousel-slider" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <img src="{{asset('images/bg/3.png')}}" alt="">
          <div class="carousel-caption text-left">
            <h3 class="wow fadeInRight" data-wow-delay="0.2s">DOMOTIKLUX</h1>  
            <h2 class="wow fadeInRight" data-wow-delay="0.4s">Le rêve de votre maison intelligente est désormais une réalité!</h2>
            <h4 class="wow fadeInRight" data-wow-delay="0.6s">Une gamme complète de produits de domotique !</h4>
            <a href="#services" class="btn btn-lg btn-common btn-effect wow fadeInRight" data-wow-delay="0.9s">Voir plus</a>
            <a href="#cta" class="btn btn-lg btn-border wow fadeInRight" data-wow-delay="1.2s">Contactez-nous !</a>
          </div>
        </div>
        <div class="carousel-item">
          <img src="{{asset('images/bg/8.png')}}" alt="">
          <div class="carousel-caption text-center">
            ...
            <h4 class="wow fadeInUp" data-wow-delay="0.9s">Contrôler, Sécuriser à distance  et Réduiser les charges de votre maison !</h4>
            <a href="#produits" class="btn btn-lg btn-common btn-effect wow fadeInUp" data-wow-delay="1.2s">Voir plus</a>
          </div>
        </div>
        <div class="carousel-item">
          <img src="{{asset('images/bg/6.png')}}" alt="">
          <div class="carousel-caption text-center">
